...
const {
  ...
  PRODUCTS_BASE_URL = "https://giaic-hackathon-template-08.vercel.app/api/products", // API base URL for products and categories
  CATEGORIES_BASE_URL = "https://giaic-hackathon-template-08.vercel.app/api/categories", // API base URL for products and categories
} = process.env;
